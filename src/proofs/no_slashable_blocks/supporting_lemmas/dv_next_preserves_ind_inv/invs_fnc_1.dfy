...
module Fnc_Invs_1
{
    ...
    //     proposer_duty: ProposerDuty, 
    //     dvc': DVCState)
    // requires f_start_next_duty.requires(dvc, proposer_duty)
    // requires dvc' == f_start_next_duty(dvc, proposer_duty).state
    // ensures dvc'.all_rcvd_duties == dvc.all_rcvd_duties        
    // { }  
    ...
    // // // lemma lem_inv_queued_att_duty_is_rcvd_duty_f_start_next_duty(process: DVCState, proposer_duty: ProposerDuty, process': DVCState)
    // // // requires f_start_next_duty.requires(process, proposer_duty)
    ...
    // // // lemma lem_inv_queued_att_duty_is_rcvd_duty_f_serve_proposer_duty(
    // // //     process: DVCState,
    // // //     proposer_duty: ProposerDuty,
    // // //     process': DVCState
    // // // )  
    ...
    // lemma lem_inv_current_att_duty_is_rcvd_duty_f_terminate_current_proposer_duty(
    //     process: DVCState,
    //     process': DVCState
    // )
    ...
    // lemma lem_inv_current_att_duty_is_rcvd_duty_f_serve_proposer_duty(
    //     process: DVCState,
    //     proposer_duty: ProposerDuty,
    //     process': DVCState
    // )  
    ...
    //     lem_inv_current_att_duty_is_rcvd_duty_f_terminate_current_proposer_duty(
    //         process_rcvd_duty,
    //         process_after_stopping_active_consensus_instance
    //     );
    ...
    // lemma lem_inv_none_latest_served_duty_implies_none_current_att_duty_f_start_next_duty(process: DVCState, proposer_duty: ProposerDuty, process': DVCState)
    // requires f_start_next_duty.requires(process, proposer_duty)
    // requires process' == f_start_next_duty(process, proposer_duty).state        
    ...
    // lemma lem_inv_none_latest_served_duty_implies_none_current_att_duty_f_terminate_current_proposer_duty(
    //     process: DVCState,
    //     process': DVCState
    // )
    // requires f_terminate_current_proposer_duty.requires(process)
    ...
    // lemma lem_inv_none_latest_served_duty_implies_none_current_att_duty_f_serve_proposer_duty(
    //     process: DVCState,
    //     proposer_duty: ProposerDuty,
    //     process': DVCState
    // )  
    ...
    //             process.(all_rcvd_duties := process.all_rcvd_duties + {proposer_duty});
    //     var process_after_stopping_active_consensus_instance := f_terminate_current_proposer_duty(process_rcvd_duty);
    //     lem_inv_none_latest_served_duty_implies_none_current_att_duty_f_terminate_current_proposer_duty(
    //         process_rcvd_duty,
    //         process_after_stopping_active_consensus_instance
    //     );
    ...
    // lemma lem_inv_current_att_duty_is_either_none_or_latest_served_duty_f_serve_proposer_duty(
    //     process: DVCState,
    //     proposer_duty: ProposerDuty,
    //     process': DVCState
    // )  
    ...
    // lemma lem_inv_current_att_duty_is_either_none_or_latest_served_duty_f_terminate_current_proposer_duty(
    //     process: DVCState,
    //     process': DVCState
    // )
    // requires f_terminate_current_proposer_duty.requires(process)
    ...
    // lemma lem_inv_available_current_att_duty_is_latest_served_att_duty_f_terminate_current_proposer_duty(
    //     process: DVCState,
    //     process': DVCState
    // )
    // requires f_terminate_current_proposer_duty.requires(process)
    ...
    // lemma lem_inv_available_current_att_duty_is_latest_served_att_duty_f_serve_proposer_duty(
    //     process: DVCState,
    //     proposer_duty: ProposerDuty,
    //     process': DVCState
    // )  
    ...
    //             process.(all_rcvd_duties := process.all_rcvd_duties + {proposer_duty});
    //     var process_after_stopping_active_consensus_instance := f_terminate_current_proposer_duty(process_rcvd_duty);
    //     lem_inv_available_current_att_duty_is_latest_served_att_duty_f_terminate_current_proposer_duty(
    //         process_rcvd_duty,
    //         process_after_stopping_active_consensus_instance
    //     );
    ...
    // // // lemma lem_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_start_next_duty(process: DVCState, proposer_duty: ProposerDuty, process': DVCState)
    // // // requires f_start_next_duty.requires(process, proposer_duty)
    // // // requires process' == f_start_next_duty(process, proposer_duty).state        
    ...
    // // // lemma lem_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_serve_proposer_duty(
    // // //     process: DVCState,
    // // //     proposer_duty: ProposerDuty,
    // // //     process': DVCState
    // // // )  
    ...
    // // // lemma lem_inv_strictly_increasing_queue_of_att_duties_f_start_next_duty(process: DVCState, proposer_duty: ProposerDuty, process': DVCState)
    // // // requires f_start_next_duty.requires(process, proposer_duty)
    // // // requires process' == f_start_next_duty(process, proposer_duty).state        
    ...
    // // // lemma lem_inv_strictly_increasing_queue_of_att_duties_f_serve_proposer_duty(
    // // //     process: DVCState,
    // // //     proposer_duty: ProposerDuty,
    // // //     process': DVCState
    // // // )  
    ...
    // // // requires process' == f_serve_proposer_duty(process, proposer_duty).state
    // // // requires inv_queued_att_duty_is_rcvd_duty_body(process)  
    // // // requires concl_future_att_duty_is_higher_than_queued_att_duty_body(process, proposer_duty)  
    // // // requires inv_strictly_increasing_queue_of_att_duties_body(process)
    // // // ensures inv_strictly_increasing_queue_of_att_duties_body(process')
    // // // {
    // // //     var process_mod := f_enqueue_new_att_duty(
    ...
    // // // lemma lem_inv_queued_att_duty_is_higher_than_latest_served_att_duty_f_start_next_duty(process: DVCState, proposer_duty: ProposerDuty, process': DVCState)
    // // // requires f_start_next_duty.requires(process, proposer_duty)
    // // // requires process' == f_start_next_duty(process, proposer_duty).state   
    // // // requires forall queued_duty: ProposerDuty | queued_duty in process.attestation_duties_queue ::
    ...
    // // // lemma lem_inv_queued_att_duty_is_higher_than_latest_served_att_duty_f_serve_proposer_duty(
    // // //     process: DVCState,
    // // //     proposer_duty: ProposerDuty,
    // // //     process': DVCState
    // // // )  
    ...
    // // // requires process' == f_serve_proposer_duty(process, proposer_duty).state
    // // // requires inv_queued_att_duty_is_rcvd_duty_body(process)  
    // // // requires inv_att_duty_in_next_delivery_is_not_lower_than_latest_served_att_duty_body(process, proposer_duty)  
    // // // requires concl_future_att_duty_is_higher_than_queued_att_duty_body(process, proposer_duty)  
    // // // requires inv_strictly_increasing_queue_of_att_duties_body(process)
    // // // requires inv_queued_att_duty_is_higher_than_latest_served_att_duty_body(process)
    // // // requires forall queued_duty: ProposerDuty | queued_duty in process.attestation_duties_queue ::
    ...
    // lemma lem_inv_no_active_consensus_instance_before_receiving_an_att_duty_f_start_next_duty(process: DVCState, proposer_duty: ProposerDuty, process': DVCState)
    // requires f_start_next_duty.requires(process, proposer_duty)
    // requires process' == f_start_next_duty(process, proposer_duty).state   
    // requires inv_no_active_consensus_instance_before_receiving_an_att_duty_body(process)
    // ensures inv_no_active_consensus_instance_before_receiving_an_att_duty_body(process')
    ...
    // lemma lem_inv_no_active_consensus_instance_before_receiving_an_att_duty_body_f_terminate_current_proposer_duty(
    //     process: DVCState,
    //     process': DVCState
    // )
    // requires f_terminate_current_proposer_duty.requires(process)
    ...
    // lemma lem_inv_no_active_consensus_instance_before_receiving_an_att_duty_body_f_serve_proposer_duty(
    //     process: DVCState,
    //     proposer_duty: ProposerDuty,
    //     process': DVCState
    // )  
    ...
    //             process.(all_rcvd_duties := process.all_rcvd_duties + {proposer_duty});
    //     var process_after_stopping_active_consensus_instance := f_terminate_current_proposer_duty(process_rcvd_duty);
    //     lem_inv_no_active_consensus_instance_before_receiving_an_att_duty_body_f_terminate_current_proposer_duty(
    //         process_rcvd_duty,
    //         process_after_stopping_active_consensus_instance
    //     );
    ...
    // lemma lem_inv_slot_of_active_consensus_instance_is_not_higher_than_slot_of_latest_served_att_duty_body_f_terminate_current_proposer_duty(
    //     process: DVCState,
    //     process': DVCState
    // )
    // requires f_terminate_current_proposer_duty.requires(process)
    ...
    // requires inv_no_active_consensus_instance_before_receiving_an_att_duty_body(process)
    // requires inv_latest_served_duty_is_rcvd_duty_body(process)
    // requires inv_att_duty_in_next_delivery_is_not_lower_than_rcvd_att_duties_body(process, proposer_duty)
    // requires inv_slot_of_active_consensus_instance_is_not_higher_than_slot_of_latest_served_att_duty_body(process)
    // ensures inv_slot_of_active_consensus_instance_is_not_higher_than_slot_of_latest_served_att_duty_body(process')
    // { } 
    ...
    // lemma lem_inv_slot_of_active_consensus_instance_is_not_higher_than_slot_of_latest_served_att_duty_body_f_serve_proposer_duty(
    //     process: DVCState,
    //     proposer_duty: ProposerDuty,
    //     process': DVCState
    // )  
    ...
    // lemma lem_inv_consensus_instance_only_for_slot_in_which_dvc_has_rcvd_att_duty_body_f_terminate_current_proposer_duty(
    //     process: DVCState,
    //     process': DVCState
    // )
    // requires f_terminate_current_proposer_duty.requires(process)
    ...
    // lemma lem_inv_consensus_instance_only_for_slot_in_which_dvc_has_rcvd_att_duty_body_f_serve_proposer_duty(
    //     process: DVCState,
    //     proposer_duty: ProposerDuty,
    //     process': DVCState
    // )  
    ...
    //             process.(all_rcvd_duties := process.all_rcvd_duties + {proposer_duty});
    //     var process_after_stopping_active_consensus_instance := f_terminate_current_proposer_duty(process_rcvd_duty);
    //     lem_inv_consensus_instance_only_for_slot_in_which_dvc_has_rcvd_att_duty_body_f_terminate_current_proposer_duty(
    //         process_rcvd_duty,
    //         process_after_stopping_active_consensus_instance
    //     );
    ...
    // lemma lem_inv_consensus_instances_only_for_rcvd_duties_body_f_start_next_duty(process: DVCState, proposer_duty: ProposerDuty, process': DVCState)
    // requires f_start_next_duty.requires(process, proposer_duty)
    // requires process' == f_start_next_duty(process, proposer_duty).state   
    // requires proposer_duty in process.all_rcvd_duties
    // requires inv_consensus_instances_only_for_rcvd_duties_body(process)
