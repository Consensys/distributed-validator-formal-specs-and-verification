...
module Invs_DV_Next_5
{
    ...
    ensures s.sequence_of_proposer_duties_to_be_served == s'.sequence_of_proposer_duties_to_be_served  
    { }  

    lemma lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_helper_honest(
        s: BlockDVState,
        event: DVBlockEvent,
        s': BlockDVState
    )
    ...
    requires inv_available_current_proposer_duty_is_from_dv_seq_of_proposer_duties(s)
    requires inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist(s)
    ensures inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body(s'.sequence_of_proposer_duties_to_be_served, event.node, s'.honest_nodes_states[event.node], s'.index_next_proposer_duty_to_be_served); 
    {
        assert s.sequence_of_proposer_duties_to_be_served == s'.sequence_of_proposer_duties_to_be_served;
        var sequence_of_proposer_duties_to_be_served := s'.sequence_of_proposer_duties_to_be_served;
        ...
        match event 
        {
            ...
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                ...
                lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_helper(s, event, s', s_node, node);
                assert inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body(sequence_of_proposer_duties_to_be_served, node, s_node, s.index_next_proposer_duty_to_be_served);
                ...
                match nodeEvent
                {
                    case ServeProposerDuty(proposer_duty) => 
                        ...
                        lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body_f_serve_proposer_duty(
                            s_node,
                            proposer_duty,
                            s'_node,
                        ...
                        assert inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body(sequence_of_proposer_duties_to_be_served, node, s'_node, s'.index_next_proposer_duty_to_be_served);                     
                
                    case ReceiveRandaoShare(randao_share) =>                             
                        lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body_f_listen_for_randao_shares(
                            s_node, 
                            randao_share, 
                            s'_node,
                            sequence_of_proposer_duties_to_be_served, 
                    ...
                    case BlockConsensusDecided(id, decided_beacon_block) =>  
                        ...
                        {
                            lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body_f_block_consensus_decided(
                                s_node,
                                id,
                    ...
                    case ReceiveSignedBeaconBlock(block_share) =>
                        lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body_f_listen_for_block_signature_shares(
                            s_node, 
                            block_share, 
                            s'_node,
                            sequence_of_proposer_duties_to_be_served, 
                    ...
                    case ImportedNewBlock(block) => 
                        ...
                        lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body_f_listen_for_new_imported_blocks(
                            s_node2,
                            block,
                            s'_node,
                            sequence_of_proposer_duties_to_be_served, 
                    ...
                    case ResendRandaoRevealSignatureShare =>
                        lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body_f_resend_randao_shares(
                            s_node,
                            s'_node,
                            sequence_of_proposer_duties_to_be_served, 
                            node,
                    ...
                    case ResendBlockShare =>
                        lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_body_f_resend_block_shares(
                            s_node,
                            s'_node,
                            sequence_of_proposer_duties_to_be_served, 
                            node,
    ...
    lemma lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_dv_next(
        s: BlockDVState,
        event: DVBlockEvent,
        s': BlockDVState
    )
    ...
    requires inv_available_current_proposer_duty_is_from_dv_seq_of_proposer_duties(s)
    requires inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist(s)
    ensures inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist(s')
    {
            match event 
        {
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                lem_inv_exists_proposer_duty_in_dv_seq_of_proposer_duties_for_every_slot_in_slashing_db_hist_helper_honest(
                    s,
                    event,
                    s'
                );
    ...
    {        
        ...
        assert  dv.block_share_network.allMessagesSent + f_get_messages_from_messages_with_recipients(nodeOutputs.sent_block_shares)
                ==
        ...
        forall hn: BLSPubkey, block_share: SignedBeaconBlock | 
                    ...
                    && var hn_node': BlockDVCState := dv'.honest_nodes_states[hn];
                    && var hn_rs_pubkey: BLSPubkey := hn_node'.rs.pubkey;
                    && pred_is_owner_of_block_share(hn_rs_pubkey, block_share)
        ensures && var hn_node': BlockDVCState := dv'.honest_nodes_states[hn];
                && inv_sent_block_shares_have_corresponding_stored_slashing_db_blocks_body(hn_node', block_share)            
        {
            ...
            {                        
                assert block_share in f_get_messages_from_messages_with_recipients(nodeOutputs.sent_block_shares);
                ...
                assert pred_is_owner_of_block_share(dvc'.rs.pubkey, block_share);
                assert pred_is_owner_of_block_share(hn_rs_pubkey, block_share);
        ...
        match event 
        {
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                ...
                match nodeEvent
                {
                    ...
                    case ResendRandaoRevealSignatureShare =>
                        lem_inv_outputs_sent_block_shares_are_tracked_in_block_slashing_db_f_resend_randao_shares(dvc, dvc');
                        assert inv_outputs_sent_block_shares_are_tracked_in_block_slashing_db(nodeOutputs, dvc');      
                                                
                    case ReceiveSignedBeaconBlock =>       
                        lem_inv_outputs_sent_block_shares_are_tracked_in_block_slashing_db_f_resend_block_shares(dvc, dvc');
                        assert inv_outputs_sent_block_shares_are_tracked_in_block_slashing_db(nodeOutputs, dvc');                    
    ...
    {        
        ...
        match event 
        {
            ...
            case AdversaryTakingStep(node, new_randao_shares_sent, new_sent_block_shares, randaoShareReceivedByTheNode, blockShareReceivedByTheNode) =>
                assert  next_adversary(dv, node, new_randao_shares_sent, new_sent_block_shares, randaoShareReceivedByTheNode, blockShareReceivedByTheNode, dv');                        
                ...
                ensures block_signature_is_signed_with_pubkey(aggregated_block_sent, dv.dv_pubkey)
                {
                    assert block_signature_is_signed_with_pubkey(aggregated_block_sent, dv.dv_pubkey);
                }
    ...
    lemma lem_inv_complete_signed_block_is_created_based_on_shares_from_quorum_dv_next_AdversaryTakingStep(
        dv: BlockDVState,
        event: DVBlockEvent,
        dv': BlockDVState
    )    
    ...
    requires inv_unchanged_dvc_rs_pubkey(dv)
    requires inv_complete_signed_block_is_created_based_on_shares_from_quorum(dv)
    ensures  inv_complete_signed_block_is_created_based_on_shares_from_quorum(dv')
    {        
        lem_inv_only_dv_construct_complete_signing_functions_dv_next(dv, event, dv');
        assert inv_only_dv_construct_complete_signing_functions(dv');
        ...
        match event 
        {
            case AdversaryTakingStep(node, new_randao_shares_sent, new_sent_block_shares, randaoShareReceivedByTheNode, blockShareReceivedByTheNode) =>
                ...
                ensures inv_complete_signed_block_is_created_based_on_shares_from_quorum_body(dv', new_signed_block_created)
                {
                    assert inv_complete_signed_block_is_created_based_on_shares_from_quorum_body(dv', new_signed_block_created);
                }
                                
                assert inv_complete_signed_block_is_created_based_on_shares_from_quorum(dv');
        }  
    } 

    lemma lem_inv_complete_signed_block_is_created_based_on_shares_from_quorum_dv_next_HonestNodeTakingStep(
        dv: BlockDVState,
        event: DVBlockEvent,
        dv': BlockDVState,
        node: BLSPubkey, 
    ...
    requires event == DVBlockEvent.HonestNodeTakingStep(node, nodeEvent, nodeOutputs)
    requires && var dvc' := dv'.honest_nodes_states[node];
             && inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers(
                    nodeOutputs,
                    dvc'
                )
    requires inv_only_dv_construct_complete_signing_functions(dv)
    ...
    {        
        ...
        assert inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers(nodeOutputs, dvc');
        ...
        ensures inv_complete_signed_block_is_created_based_on_shares_from_quorum_body(dv', complete_signed_block)
        {
            if complete_signed_block in dv.all_blocks_created 
            {
                assert inv_complete_signed_block_is_created_based_on_shares_from_quorum_body(dv, complete_signed_block);
                var block_shares, dvc_signer_pubkeys :|
                        ...
                        && signed_beacon_blocks_for_same_beacon_block(block_shares, complete_signed_block.block)
                ...
                assert  inv_complete_signed_block_is_created_based_on_shares_from_quorum_of_dvc_signers(dv', block_shares, dvc_signer_pubkeys);
                assert  inv_complete_signed_block_is_created_based_on_shares_from_quorum_body(dv', complete_signed_block);
            }
            else
            {
                assert complete_signed_block in nodeOutputs.submitted_data;
                assert inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers_body(dvc', complete_signed_block);
                ...
                assert  inv_complete_signed_block_is_created_based_on_shares_from_quorum_of_dvc_signers(dv', block_shares, rs_signer_pubkeys);                
                assert inv_complete_signed_block_is_created_based_on_shares_from_quorum_body(dv', complete_signed_block);
            }
        }
        assert inv_complete_signed_block_is_created_based_on_shares_from_quorum(dv');            
    ...
    lemma lem_inv_complete_signed_block_is_created_based_on_shares_from_quorum_dv_next(
        dv: BlockDVState,
        event: DVBlockEvent,
        dv': BlockDVState
    )    
    ...
    {        
        ...
        match event 
        {
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                ...
                {
                    case ServeProposerDuty(proposer_duty) =>     
                        lem_inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers_f_serve_proposer_duty(dvc, proposer_duty, dvc');
                    
                    case ReceiveRandaoShare(randao_share) =>
                        lem_inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers_f_listen_for_randao_shares(dvc, randao_share, dvc');
                        
                    case BlockConsensusDecided(id, decided_beacon_block) => 
                        if f_block_consensus_decided.requires(dvc, id, decided_beacon_block)
                        {
                            lem_inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers_f_block_consensus_decided(dvc, id, decided_beacon_block, dvc');      
                        }                 
                        
                    case ReceiveSignedBeaconBlock(block_share) =>                         
                        lem_inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers_f_listen_for_block_signature_shares(dvc, block_share, dvc');                        
   
                    case ImportedNewBlock(block) => 
                        var dvc := f_add_block_to_bn(dvc, nodeEvent.block);
                        lem_inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers_f_listen_for_new_imported_blocks(dvc, block, dvc');                        
                                                
                    case ReceiveSignedBeaconBlock =>   
                        lem_inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers_f_resend_block_shares(dvc, dvc');

                    case ResendRandaoRevealSignatureShare =>                      
                        lem_inv_outputs_blocks_submited_are_created_based_on_shares_from_quorum_of_rs_signers_f_resend_randao_shares(dvc, dvc');
                ...
                lem_inv_complete_signed_block_is_created_based_on_shares_from_quorum_dv_next_HonestNodeTakingStep(
                    dv,
                    event,
                    dv',
                    node, 
            ...
            case AdversaryTakingStep(node, new_randao_shares_sent, new_sent_block_shares, randaoShareReceivedByTheNode, blockShareReceivedByTheNode) =>
                lem_inv_complete_signed_block_is_created_based_on_shares_from_quorum_dv_next_AdversaryTakingStep(
                    dv,
                    event,
                    dv'
                );
    ...
    lemma lem_inv_slots_for_sent_validity_predicates_are_stored_in_slashing_db_hist_implies_46_a(dv: BlockDVState)
    ...
    requires Block_DVC.next.requires(s, event, s', outputs)
    requires Block_DVC.next(s, event, s', outputs)
    ...
    lemma lem_inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty_dv_next(
        s: BlockDVState,
        event: DVBlockEvent,
        s': BlockDVState
    )
    requires next_event_preconditions(s, event)
    requires next_event(s, event, s')  
    requires inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty(s)        
    requires inv_active_consensus_instances_are_tracked_in_slashing_db_hist(s)  
    requires inv_active_consensus_instances_are_tracked_in_slashing_db_hist(s)
    ...
    ensures inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty(s');  
    {
        assert s.block_share_network.allMessagesSent <= s'.block_share_network.allMessagesSent;
        match event 
        {            
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                ...
                {
                    case ServeProposerDuty(proposer_duty) =>     
                        lem_inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty_body_f_serve_proposer_duty(process, proposer_duty, process');
                    
                    case ReceiveRandaoShare(randao_share) =>                         
                        lem_inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty_body_f_listen_for_randao_shares(process, randao_share, process');    
                        
                    case BlockConsensusDecided(id, decided_beacon_block) => 
                        if f_block_consensus_decided.requires(process, id, decided_beacon_block)
                        {
                            lem_inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty_body_f_block_consensus_decided(process, id, decided_beacon_block, process');      
                        }                 
                        
                    case ReceiveSignedBeaconBlock(block_share) =>                         
                        lem_inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty_body_f_listen_for_block_signature_shares(process, block_share, process');                        
   
                    case ImportedNewBlock(block) => 
                        var process := f_add_block_to_bn(process, nodeEvent.block);
                        lem_inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty_body_f_listen_for_new_imported_blocks(process, block, process');                        
    ...
    lemma lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_f_f_add_block_to_bn_with_event(
        dv: BlockDVState,
        node: BLSPubkey, 
        nodeEvent: BlockEvent, 
        dv': BlockDVState
    ...
    lemma lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_Consensus_next_consensus_decides<D(!new, 0)>(
        s: ConsensusInstance,
        honest_nodes_validity_predicates: map<BLSPubkey, D -> bool>,        
        s': ConsensusInstance
    )    
    ...
    requires inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_body(s)
    requires condition_for_safety_is_true(s)
    ensures  inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_body(s')
    { }

    lemma lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_Consensus_Next<D(!new, 0)>(
        s: ConsensusInstance,
        honest_nodes_validity_predicates: map<BLSPubkey, D -> bool>,        
        s': ConsensusInstance,
    ...
    ensures  inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_body(s')
    {
        lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_Consensus_next_consensus_decides(s, honest_nodes_validity_predicates, s');
    }

    lemma lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_consensus_instance_step(
        dv: BlockDVState,
        node: BLSPubkey, 
        nodeEvent: BlockEvent, 
        nodeOutputs: BlockOutputs,
    ...
    requires && Block_DV.consensus_instance_step.requires(dv, node, nodeEvent, nodeOutputs, dv')
             && Block_DV.consensus_instance_step(dv, node, nodeEvent, nodeOutputs, dv')
    requires inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block(dv)
    ...
    {        
        ...
        ensures inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_body(dv'.consensus_instances_on_beacon_block[cid])
        {
            assert condition_for_safety_is_true(dv.consensus_instances_on_beacon_block[cid]);
            ...
            lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_Consensus_Next(
                dv.consensus_instances_on_beacon_block[cid],
                validityPredicates,
                dv'.consensus_instances_on_beacon_block[cid],
                output
    ...
    lemma lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_next_honest_node_after_adding_block_to_bn(
        dv: BlockDVState,
        node: BLSPubkey, 
        nodeEvent: BlockEvent, 
        nodeOutputs: BlockOutputs,
    ...
    requires && Block_DV.next_honest_node_after_adding_block_to_bn.requires(dv, node, nodeEvent, nodeOutputs, dv')
             && Block_DV.next_honest_node_after_adding_block_to_bn(dv, node, nodeEvent, nodeOutputs, dv')
    requires inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block(dv)
    requires inv_consensus_instance_condition_for_safety_is_true(dv)
    ensures  inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block(dv')
    {        
        assert consensus_instance_step(dv, node, nodeEvent, nodeOutputs, dv');
        lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_consensus_instance_step(dv, node, nodeEvent, nodeOutputs, dv');
    } 

    lemma lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_next_honest_node(
        dv: BlockDVState,
        node: BLSPubkey, 
        nodeEvent: BlockEvent, 
        nodeOutputs: BlockOutputs,
    ...
    requires && Block_DV.next_honest_node.requires(dv, node, nodeEvent, nodeOutputs, dv')
             && Block_DV.next_honest_node(dv, node, nodeEvent, nodeOutputs, dv')
    requires inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block(dv)
    requires inv_consensus_instance_condition_for_safety_is_true(dv)
    ensures  inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block(dv')
    {        
        ...
        lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_next_honest_node_after_adding_block_to_bn(
            dv_w_honest_node_states_updated, 
            node, 
            nodeEvent, 
            nodeOutputs, dv');
    ...
    lemma lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_dv_next(
        dv: BlockDVState,
        event: DVBlockEvent,
        dv': BlockDVState
    )    
    ...
    {        
        ...
        {
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                lem_inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block_next_honest_node(
                    dv,
                    node, 
                    nodeEvent, 
                    nodeOutputs,
            ...
            case AdversaryTakingStep(node, new_randao_shares_sent, new_sent_block_shares, randaoShareReceivedByTheNode, blockShareReceivedByTheNode) =>
                assert inv_exists_honest_dvc_as_witness_for_every_decided_beacon_block(dv');
        }   
    }          

    lemma lem_different_signers_cannot_generate_same_block_share(
        rs_pubkey: BLSPubkey,
        rs_pubkey': BLSPubkey,
    ...
    ensures !pred_is_owner_of_block_share(rs_pubkey', block_share)
    {
        if pred_is_owner_of_block_share(rs_pubkey', block_share)
        {
    ...
    ensures inv_honest_nodes_are_not_owners_of_block_shares_from_adversary(dv)
    {
        ...
        ensures inv_honest_nodes_are_not_owners_of_block_shares_from_adversary_body(dv, block_share)
        {
            ...
            ensures !pred_is_owner_of_block_share(hn, block_share)
            {
                assert hn != byz_node;
                lem_different_signers_cannot_generate_same_block_share(
                    byz_node,
                    hn,
                    block_share
                );
                assert !pred_is_owner_of_block_share(hn, block_share);
            }
        }
    }
    ...
    requires next_event(dv, event, dv') 
    requires event.AdversaryTakingStep? 
    requires next_adversary(dv, node, new_randao_share_sent, new_block_share_sent, randaoShareReceivedByTheNode, blockShareReceivedByTheNode, dv')
    requires inv_all_honest_nodes_is_quorum(dv)
    requires is_honest_node(dv', pubkey)
    requires && old_block_share in dv'.block_share_network.allMessagesSent
             && pred_is_owner_of_block_share(pubkey, old_block_share)
    ensures old_block_share in dv.block_share_network.allMessagesSent
    {
        ...
        assert  dv'.block_share_network.allMessagesSent
                == 
                dv.block_share_network.allMessagesSent + f_get_messages_from_messages_with_recipients(new_block_share_sent);

        assert  || old_block_share in dv.block_share_network.allMessagesSent
                || old_block_share in f_get_messages_from_messages_with_recipients(new_block_share_sent)
                ;

        if old_block_share in f_get_messages_from_messages_with_recipients(new_block_share_sent)
        {
            if new_block_share_sent == {}
            {
                assert {} == f_get_messages_from_messages_with_recipients(new_block_share_sent);
            }
            assert {} != f_get_messages_from_messages_with_recipients(new_block_share_sent);
        ...
        assert old_block_share !in f_get_messages_from_messages_with_recipients(new_block_share_sent);
        assert old_block_share in dv.block_share_network.allMessagesSent;
    }
    ...
    requires inv_unchanged_dvc_rs_pubkey(dv)
    requires inv_all_honest_nodes_is_quorum(dv)
    requires inv_block_shares_to_broadcast_is_subset_of_all_sent_messages(dv)
    requires inv_sent_block_shares_have_corresponding_stored_slashing_db_blocks(dv)
    requires inv_db_of_vp_contains_all_beacon_block_of_sent_block_shares_with_lower_slots(dv)
    requires inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty(dv)
    requires inv_available_current_proposer_duty_is_latest_proposer_duty(dv)
    requires inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty(dv)
            ...
            )
    {
                    ...
                    db)
        {
            ...
            ensures && var beacon_block := block_share.block;
                    ...
                    && slashing_db_block in db
            {
                assert  inv_db_of_vp_from_sent_block_share_contains_all_beacon_blocks_of_sent_block_shares_with_lower_slots_dvc_body_conclusion(
                            allMessagesSent,
                            rs_pubkey,
                            slot,
                            vp,
    ...
    requires inv_available_latest_proposer_duty_is_from_dv_seq_of_proposer_duties(dv)
    requires inv_seq_of_proposer_duties_is_ordered(dv)
    ensures  && var allMessagesSent := dv'.block_share_network.allMessagesSent;
             var process' := dv'.honest_nodes_states[node];
    ...
    {        
        ...
        assert  inv_db_of_vp_from_sent_block_share_contains_all_beacon_blocks_of_sent_block_shares_with_lower_slots_dvc(allMessagesSent, process);

        lem_inv_db_of_vp_from_sent_block_share_contains_all_beacon_blocks_of_sent_block_shares_with_lower_slots_dvc_f_serve_proposer_duty(                            
            process,
            proposer_duty,
            process',
            allMessagesSent
    ...
    {        
        ...
        lem_inv_db_of_vp_contains_all_beacon_block_of_sent_block_shares_with_lower_slots_ServeProposerDuty_helper(
            dv,
            event,
            dv',
            node,
    ...
    {        
        ...
        if f_block_consensus_decided.requires(dvc, id, decided_beacon_block)
        {
                ...
                && id == decided_beacon_block.slot
            {
                ...
                lem_inv_slots_of_consensus_instances_are_up_to_slot_of_latest_proposer_duty_dv_next(
                    dv,
                    event,
                    dv'
                );
                ...
                lem_inv_db_of_vp_from_sent_block_share_contains_all_beacon_blocks_of_sent_block_shares_with_lower_slots_dvc_f_block_consensus_decided_new_sent_block_shares(                            
                            dvc,
                            id,
                            decided_beacon_block, 
                            dvc',
                ...
                assert allMessagesSent' == allMessagesSent + f_get_messages_from_messages_with_recipients(outputs.sent_block_shares);
                ...
                var block_signature := af_rs_sign_block(decided_beacon_block, fork_version, block_signing_root, dvc.rs);
    ...
    //     lem_inv_db_of_vp_from_sent_block_share_contains_all_beacon_blocks_of_sent_block_shares_with_lower_slots_dvc_f_listen_for_new_imported_blocks(            
    //         dvc_after_adding_block,
    //         block,
    //         dvc',
    //         dv.block_share_network.allMessagesSent
    ...
    {                
        ...
        lem_inv_db_of_vp_from_sent_block_share_contains_all_beacon_blocks_of_sent_block_shares_with_lower_slots_dvc_f_listen_for_block_signature_shares(
            dvc,
            block_share,
            dvc',
            dv.block_share_network.allMessagesSent
    ...
    {                
        ...
        lem_inv_db_of_vp_from_sent_block_share_contains_all_beacon_blocks_of_sent_block_shares_with_lower_slots_dvc_f_resend_randao_shares(
            dvc,
            dvc',
            dv.block_share_network.allMessagesSent
        );
    ...
    {                
        ...
        lem_inv_db_of_vp_from_sent_block_share_contains_all_beacon_blocks_of_sent_block_shares_with_lower_slots_dvc_f_resend_block_shares(
            dvc,
            dvc',
            dv.block_share_network.allMessagesSent
        );
    ...
    {   
        ...
        assert  && state_and_outputs.state == dvc'
                && state_and_outputs.outputs == f_get_empty_block_ouputs()
                ;
        ...
        lem_inv_db_of_vp_from_sent_block_share_contains_all_beacon_blocks_of_sent_block_shares_with_lower_slots_dvc_f_listen_for_randao_shares(
            dvc,
            randao_share,
            dvc',
            dv.block_share_network.allMessagesSent
    ...
    {        
        forall complete_block | complete_block in dv.all_blocks_created && block_signature_is_signed_with_pubkey(complete_block, dv.dv_pubkey)
    ...
    lemma lem_inv_set_of_all_blocks_created_is_monotonic_dv_next(dv: BlockDVState, event: DVBlockEvent, dv': BlockDVState)    
    requires next_event_preconditions(dv, event)
    requires next_event(dv, event, dv')     
    ...
    requires inv_consensus_instance_condition_for_safety_is_true(dv)
    requires inv_exists_honest_dvc_that_sent_block_share_for_submitted_block(dv)
    requires assump_construction_of_complete_signed_block(
    ...
    requires inv_same_node_status_between_dv_and_ci(dv)
    requires inv_only_dv_construct_complete_signing_functions(dv)
    requires inv_blocks_of_in_transit_block_shares_are_decided_values(dv)
    requires inv_decided_value_of_consensus_instance_for_slot_k_is_for_slot_k(dv)
    requires inv_block_shares_to_broadcast_is_subset_of_all_sent_messages(dv)
    requires inv_decided_values_of_consensus_instances_are_decided_by_quorum(dv)
    ...
    ensures inv_future_decided_blocks_known_by_dvc_are_decisions_of_quorums_body(dv', event.node, dv'.honest_nodes_states[event.node]); 
    {
        ...
        match nodeEvent
        {
            case ImportedNewBlock(block) =>
                ...
                lem_inv_set_of_all_blocks_created_is_monotonic_dv_next(dv, event, dv');
        ...
        match event 
        {
            ...
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                ...
                match nodeEvent
                {
                    ...
                    case ResendRandaoRevealSignatureShare =>
                        lem_inv_slots_in_future_decided_beacon_blocks_are_correct_body_f_resend_randao_shares(
                            s_node,
                            s'_node
                        );

                    case ResendBlockShare =>
                        lem_inv_slots_in_future_decided_beacon_blocks_are_correct_body_f_resend_block_shares(
                            s_node,
                            s'_node
                        );
    ...
    ensures inv_block_shares_to_broadcast_are_sent_messages(dv')
    {
        ...
        match nodeEvent
        {
            ...
            case BlockConsensusDecided(id, decided_beacon_block) => 
                ...
                if id == decided_beacon_block.slot
                {
                    ...
                    assert  block_share_network'.allMessagesSent
                            == 
                            block_share_network.allMessagesSent + f_get_messages_from_messages_with_recipients(nodeOutputs.sent_block_shares)
                            ;               
                    assert inv_block_shares_to_broadcast_are_sent_messages(dv');
                }
            ...
            case ResendRandaoRevealSignatureShare =>
                lem_inv_block_shares_to_broadcast_are_sent_messages_body_f_resend_randao_shares(dvc, dvc');
                assert inv_block_shares_to_broadcast_are_sent_messages(dv');

            case ResendBlockShare =>                         
                lem_inv_block_shares_to_broadcast_are_sent_messages_body_f_resend_block_shares(dvc, dvc');
                assert inv_block_shares_to_broadcast_are_sent_messages(dv');
    ...
    lemma lem_inv_at_most_one_submitted_signed_beacon_block_with_available_signing_root_for_every_slot_dv_next(
        dv: BlockDVState
    )    
    requires inv_block_of_all_created_blocks_is_set_of_decided_values(dv)
    ensures inv_at_most_one_submitted_signed_beacon_block_with_available_signing_root_for_every_slot(dv)
    {
    ...
    lemma lem_inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block_dv_next(
        dv: BlockDVState,
        event: DVBlockEvent,
        dv': BlockDVState
    )    
    ...
    requires inv_slots_in_slashing_db_is_not_higher_than_slot_of_latest_proposer_duty(dv)
    requires inv_none_latest_proposer_duty_implies_emply_block_slashing_db(dv)
    requires inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block(dv)
    ensures inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block(dv')
    {        
        match event 
        {
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                ...
                {
                    case ServeProposerDuty(proposer_duty) =>     
                        lem_inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block_body_f_serve_proposer_duty(process, proposer_duty, process');
                    
                    case ReceiveRandaoShare(randao_share) =>
                        lem_inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block_body_f_listen_for_randao_shares(process, randao_share, process');    
                        
                    case BlockConsensusDecided(id, decided_beacon_block) => 
                        if f_block_consensus_decided.requires(process, id, decided_beacon_block)
                        {
                            lem_inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block_body_f_block_consensus_decided(process, id, decided_beacon_block, process');      
                        }                 
                        
                    case ReceiveSignedBeaconBlock(block_share) =>                         
                        lem_inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block_body_f_listen_for_block_signature_shares(process, block_share, process');                        
   
                    case ImportedNewBlock(block) => 
                        var process := f_add_block_to_bn(process, nodeEvent.block);
                        lem_inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block_body_f_listen_for_new_imported_blocks(process, block, process');                        
                                                
                    case ResendRandaoRevealSignatureShare =>
                        lem_inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block_body_f_resend_randao_shares(process, process');

                    case ResendBlockShare =>
                        lem_inv_slots_in_slashing_db_are_not_higher_than_slot_of_latest_slashing_db_block_body_f_resend_block_shares(process, process');
