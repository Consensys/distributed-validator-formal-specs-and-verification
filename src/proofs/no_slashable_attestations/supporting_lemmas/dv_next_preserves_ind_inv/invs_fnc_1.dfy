...
module Fnc_Invs_1
{
    ...
    lemma lemma_inv_queued_att_duty_is_rcvd_duty_add_block_to_bn(
        s: DVCState,
        block: BeaconBlock,
        s': DVCState 
    )
    ...
    lemma lemma_inv_queued_att_duty_is_rcvd_duty_f_start_next_duty(process: DVCState, attestation_duty: AttestationDuty, process': DVCState)
    ...
    lemma lemma_inv_queued_att_duty_is_rcvd_duty_f_check_for_next_queued_duty(
        process: DVCState,
        process': DVCState
    )
    ...
    decreases process.attestation_duties_queue
    {
        ...
        {            
                if process.attestation_duties_queue[0].slot in process.future_att_consensus_instances_already_decided.Keys 
                {
                    ...
                    lemma_inv_queued_att_duty_is_rcvd_duty_f_check_for_next_queued_duty(process_mod, process');
                }
                else
                { 
                    var process_mod := process.(
                    ...
                    lemma_inv_queued_att_duty_is_rcvd_duty_f_start_next_duty(process_mod, process.attestation_duties_queue[0], process');
                }
        }
        else
        { 
    ...
    lemma lemma_inv_queued_att_duty_is_rcvd_duty_f_serve_attestation_duty(
        process: DVCState,
        attestation_duty: AttestationDuty,
        process': DVCState
    )  
    ...
    lemma lemma_inv_queued_att_duty_is_rcvd_duty_f_att_consensus_decided(
        process: DVCState,
        id: Slot,
        decided_attestation_data: AttestationData, 
        process': DVCState
    ...
    ensures inv_queued_att_duty_is_rcvd_duty_body(process')
    {
            ...
            && id == process.current_attestation_duty.safe_get().slot
        {
            ...
            lemma_inv_queued_att_duty_is_rcvd_duty_f_check_for_next_queued_duty(process, ret_check_for_next_queued_duty.state);

            assert process' == ret_check_for_next_queued_duty.state;
        }
    }  

    lemma lemma_inv_queued_att_duty_is_rcvd_duty_f_listen_for_attestation_shares(
        process: DVCState,
        attestation_share: AttestationShare,
        process': DVCState
    )
    ...
    lemma lemma_inv_queued_att_duty_is_rcvd_duty_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        process': DVCState
    )
    ...
    ensures inv_queued_att_duty_is_rcvd_duty_body(process')
    {
        ...
        if process.current_attestation_duty.isPresent() && process.current_attestation_duty.safe_get().slot in att_consensus_instances_already_decided
        {
            ...
            lemma_inv_queued_att_duty_is_rcvd_duty_f_check_for_next_queued_duty(process, process');
        }
        else
        {
            assert inv_queued_att_duty_is_rcvd_duty_body(process);
    ...
    lemma lemma_inv_current_att_duty_is_rcvd_duty_f_start_next_duty(process: DVCState, attestation_duty: AttestationDuty, process': DVCState)
    requires f_start_next_duty.requires(process, attestation_duty)
    requires process' == f_start_next_duty(process, attestation_duty).state    
    ...
    lemma lemma_inv_current_att_duty_is_rcvd_duty_f_check_for_next_queued_duty(
        process: DVCState,
        process': DVCState
    )
    requires f_check_for_next_queued_duty.requires(process)
    ...
    decreases process.attestation_duties_queue
    {
        ...
        {            
                if process.attestation_duties_queue[0].slot in process.future_att_consensus_instances_already_decided.Keys 
                {
                    ...
                    lemma_inv_current_att_duty_is_rcvd_duty_f_check_for_next_queued_duty(process_mod, process');
                }
                else
                { 
                    var process_mod := process.(
                    ...
                    lemma_inv_current_att_duty_is_rcvd_duty_f_start_next_duty(process_mod, process.attestation_duties_queue[0], process');
                }
        }
        else
        { 
    ...
    lemma lemma_inv_current_att_duty_is_rcvd_duty_f_serve_attestation_duty(
        process: DVCState,
        attestation_duty: AttestationDuty,
        process': DVCState
    )  
    ...
    lemma lemma_inv_current_att_duty_is_rcvd_duty_f_att_consensus_decided(
        process: DVCState,
        id: Slot,
        decided_attestation_data: AttestationData, 
        process': DVCState
    ...
    ensures inv_current_att_duty_is_rcvd_duty_body(process')
    {
            ...
            && id == process.current_attestation_duty.safe_get().slot
        {
            ...
            lemma_inv_current_att_duty_is_rcvd_duty_f_check_for_next_queued_duty(process, ret_check_for_next_queued_duty.state);

            assert process' == ret_check_for_next_queued_duty.state;
        }        
    }  

    lemma lemma_inv_current_att_duty_is_rcvd_duty_f_listen_for_attestation_shares(
        process: DVCState,
        attestation_share: AttestationShare,
        process': DVCState
    )
    ...
    lemma lemma_inv_current_att_duty_is_rcvd_duty_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        process': DVCState
    )
    ...
    ensures inv_current_att_duty_is_rcvd_duty_body(process')
    {
        ...
        if process.current_attestation_duty.isPresent() && process.current_attestation_duty.safe_get().slot in att_consensus_instances_already_decided
        {
            ...
            lemma_inv_current_att_duty_is_rcvd_duty_f_check_for_next_queued_duty(process, process');
        }
        else
        {   
            assert inv_current_att_duty_is_rcvd_duty_body(process);
    ...
    lemma lemma_inv_latest_served_duty_is_rcvd_duty_f_start_next_duty(process: DVCState, attestation_duty: AttestationDuty, process': DVCState)
    requires f_start_next_duty.requires(process, attestation_duty)
    requires process' == f_start_next_duty(process, attestation_duty).state    
    requires attestation_duty in process.all_rcvd_duties
    ...
    lemma lemma_inv_latest_served_duty_is_rcvd_duty_f_check_for_next_queued_duty(
        process: DVCState,
        process': DVCState
    )
    requires f_check_for_next_queued_duty.requires(process)
    ...
    decreases process.attestation_duties_queue
    {
        ...
        {            
                if process.attestation_duties_queue[0].slot in process.future_att_consensus_instances_already_decided.Keys 
                {
                    ...
                    lemma_inv_latest_served_duty_is_rcvd_duty_f_check_for_next_queued_duty(process_mod, process');
                }
                else
                { 
                    var process_mod := process.(
                    ...
                    assert process.attestation_duties_queue[0] in process.all_rcvd_duties;
                    lemma_inv_latest_served_duty_is_rcvd_duty_f_start_next_duty(process_mod, process.attestation_duties_queue[0], process');
                }
        }
        else
        { 
    ...
    lemma lemma_inv_latest_served_duty_is_rcvd_duty_f_serve_attestation_duty(
        process: DVCState,
        attestation_duty: AttestationDuty,
        process': DVCState
    )  
    ...
    lemma lemma_inv_latest_served_duty_is_rcvd_duty_f_att_consensus_decided(
        process: DVCState,
        id: Slot,
        decided_attestation_data: AttestationData, 
        process': DVCState
    ...
    ensures inv_latest_served_duty_is_rcvd_duty_body(process')
    {
            ...
            && id == process.current_attestation_duty.safe_get().slot
        {
            ...
            lemma_inv_latest_served_duty_is_rcvd_duty_f_check_for_next_queued_duty(process, ret_check_for_next_queued_duty.state);
    ...
    lemma lemma_inv_latest_served_duty_is_rcvd_duty_f_listen_for_attestation_shares(
        process: DVCState,
        attestation_share: AttestationShare,
        process': DVCState
    )
    ...
    lemma lemma_inv_latest_served_duty_is_rcvd_duty_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        process': DVCState
    )
    ...
    ensures inv_latest_served_duty_is_rcvd_duty_body(process')
    {
        ...
        if process.current_attestation_duty.isPresent() && process.current_attestation_duty.safe_get().slot in att_consensus_instances_already_decided
        {
            ...
            lemma_inv_latest_served_duty_is_rcvd_duty_f_check_for_next_queued_duty(process, process');
        }
        else
        {   
            assert inv_latest_served_duty_is_rcvd_duty_body(process);
    ...
    lemma lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_check_for_next_queued_duty(
        process: DVCState,
        process': DVCState
    )
    requires f_check_for_next_queued_duty.requires(process)
    ...
    decreases process.attestation_duties_queue
    {
        ...
        {            
                if process.attestation_duties_queue[0].slot in process.future_att_consensus_instances_already_decided.Keys 
                {
                    ...
                    lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_check_for_next_queued_duty(process_mod, process');
                }
                else
                { 
                    var process_mod := process.(
                    ...
                    lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_start_next_duty(process_mod, process.attestation_duties_queue[0], process');
                }
        }
        else
        { 
    ...
    lemma lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_serve_attestation_duty(
        process: DVCState,
        attestation_duty: AttestationDuty,
        process': DVCState
    )  
    ...
    lemma lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_att_consensus_decided(
        process: DVCState,
        id: Slot,
        decided_attestation_data: AttestationData, 
        process': DVCState
    ...
    ensures inv_current_att_duty_is_either_none_or_latest_served_duty_body(process')
    {
            ...
            && id == process.current_attestation_duty.safe_get().slot
        {
            ...
            lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_check_for_next_queued_duty(process, ret_check_for_next_queued_duty.state);

            assert process' == ret_check_for_next_queued_duty.state;
        }
    }  

    lemma lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_listen_for_attestation_shares(
        process: DVCState,
        attestation_share: AttestationShare,
        process': DVCState
    )
    ...
    lemma lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        process': DVCState
    )
    ...
    ensures inv_current_att_duty_is_either_none_or_latest_served_duty_body(process')
    {
        ...
        if process.current_attestation_duty.isPresent() && process.current_attestation_duty.safe_get().slot in att_consensus_instances_already_decided
        {
            ...
            lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_check_for_next_queued_duty(process, process');
        }
        else
        {   
            assert inv_current_att_duty_is_either_none_or_latest_served_duty_body(process);
    ...
    lemma lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_f_resend_attestation_share(
        process: DVCState,
        process': DVCState)
    requires f_resend_attestation_share.requires(process)
    requires process' == f_resend_attestation_share(process).state    
    ...
    lemma lemma_inv_current_att_duty_is_either_none_or_latest_served_duty_add_block_to_bn(
        s: DVCState,
        block: BeaconBlock,
        s': DVCState 
    )
    ...
    lemma lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_start_next_duty(process: DVCState, attestation_duty: AttestationDuty, process': DVCState)
    requires f_start_next_duty.requires(process, attestation_duty)
    requires process' == f_start_next_duty(process, attestation_duty).state        
    ...
    lemma lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_check_for_next_queued_duty(
        process: DVCState,
        process': DVCState
    )
    requires f_check_for_next_queued_duty.requires(process)
    ...
    decreases process.attestation_duties_queue
    {
        ...
        {            
                if process.attestation_duties_queue[0].slot in process.future_att_consensus_instances_already_decided.Keys 
                {
                    ...
                    lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_check_for_next_queued_duty(process_mod, process');
                }
                else
                { 
                    var process_mod := process.(
                    ...
                    lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_start_next_duty(process_mod, process.attestation_duties_queue[0], process');
                }
        }
        else
        { 
    ...
    lemma lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_serve_attestation_duty(
        process: DVCState,
        attestation_duty: AttestationDuty,
        process': DVCState
    )  
    ...
    lemma lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_att_consensus_decided(
        process: DVCState,
        id: Slot,
        decided_attestation_data: AttestationData, 
        process': DVCState
    ...
    ensures inv_not_none_current_att_duty_is_latest_served_att_duty_body(process')
    {
        ...
        lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_check_for_next_queued_duty(process, ret_check_for_next_queued_duty.state);

        assert process' == ret_check_for_next_queued_duty.state;
        
    }  

    lemma lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_listen_for_attestation_shares(
        process: DVCState,
        attestation_share: AttestationShare,
        process': DVCState
    )
    ...
    lemma lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        process': DVCState
    )
    ...
    ensures inv_not_none_current_att_duty_is_latest_served_att_duty_body(process')
    {
        ...
        if process.current_attestation_duty.isPresent() && process.current_attestation_duty.safe_get().slot in att_consensus_instances_already_decided
        {
            ...
            lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_check_for_next_queued_duty(process, process');
        }
        else
        {   
            assert inv_not_none_current_att_duty_is_latest_served_att_duty_body(process);
    ...
    lemma lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_f_resend_attestation_share(
        process: DVCState,
        process': DVCState)
    requires f_resend_attestation_share.requires(process)
    requires process' == f_resend_attestation_share(process).state    
    ...
    lemma lemma_inv_not_none_current_att_duty_is_latest_served_att_duty_add_block_to_bn(
        s: DVCState,
        block: BeaconBlock,
        s': DVCState 
    )
    ...
    lemma lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_check_for_next_queued_duty(
        process: DVCState,
        process': DVCState
    )
    requires f_check_for_next_queued_duty.requires(process)
    ...
    decreases process.attestation_duties_queue
    {
        ...
        {            
                if process.attestation_duties_queue[0].slot in process.future_att_consensus_instances_already_decided.Keys 
                {
                    ...
                    lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_check_for_next_queued_duty(process_mod, process');
                }
                else
                { 
                    var process_mod := process.(
    ...
    lemma lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_serve_attestation_duty(
        process: DVCState,
        attestation_duty: AttestationDuty,
        process': DVCState
    )  
    ...
    lemma lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_att_consensus_decided(
        process: DVCState,
        id: Slot,
        decided_attestation_data: AttestationData, 
        process': DVCState
    ...
    ensures inv_no_queued_att_duty_if_latest_served_att_duty_is_none_body(process')
    {
        ...
        lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_check_for_next_queued_duty(process, ret_check_for_next_queued_duty.state);

        assert process' == ret_check_for_next_queued_duty.state;
        
    }  

    lemma lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_listen_for_attestation_shares(
        process: DVCState,
        attestation_share: AttestationShare,
        process': DVCState
    )
    ...
    lemma lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        process': DVCState
    )
    ...
    ensures inv_no_queued_att_duty_if_latest_served_att_duty_is_none_body(process')
    {
        ...
        if process.current_attestation_duty.isPresent() && process.current_attestation_duty.safe_get().slot in att_consensus_instances_already_decided
        {
            ...
            lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_check_for_next_queued_duty(process, process');
        }
        else
        {   
            assert inv_no_queued_att_duty_if_latest_served_att_duty_is_none_body(process);
    ...
    lemma lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_f_resend_attestation_share(
        process: DVCState,
        process': DVCState)
    requires f_resend_attestation_share.requires(process)
    requires process' == f_resend_attestation_share(process).state    
    ...
    lemma lemma_inv_no_queued_att_duty_if_latest_served_att_duty_is_none_add_block_to_bn(
        s: DVCState,
        block: BeaconBlock,
        s': DVCState 
    )
    ...
    ensures inv_consensus_instance_only_for_slot_in_which_dvc_has_rcvd_att_duty_body(process')
    {
        ...
        lemma_inv_queued_att_duty_is_rcvd_duty_f_check_for_next_queued_duty(process, ret_dvc);
