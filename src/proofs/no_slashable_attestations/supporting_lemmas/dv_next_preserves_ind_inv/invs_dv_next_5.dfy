...
module Invs_DV_Next_5
{
    ...
    decreases s.attestation_duties_queue
    {
            ...
            )    
        {
            ...
            if s.attestation_duties_queue[0].slot in s.future_att_consensus_instances_already_decided.Keys 
            {
                ...
                lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_f_check_for_next_queued_duty_updateConsensusInstanceValidityCheck5(
                    s.attestation_consensus_engine_state,
                    new_attestation_slashing_db,
                    s_mod.attestation_consensus_engine_state,
                    cid
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_f_serve_attestation_duty(
        process: DVCState,
        attestation_duty: AttestationDuty,
        s': DVCState,
        dv: DVState,
    ...
    ensures inv_g_iii_a_body_body(dv, n, s', index_next_attestation_duty_to_be_served)
    {
        ...
        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_f_check_for_next_queued_duty(new_p, s', dv, n, index_next_attestation_duty_to_be_served);
    }       

    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_f_att_consensus_decided(
        process: DVCState,
        id: Slot,
        decided_attestation_data: AttestationData,        
        s': DVCState,
    ...
    {   
            ...
            && id == process.current_attestation_duty.safe_get().slot
        {
            ...
            lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_f_check_for_next_queued_duty(s_mod, s', dv, n, index_next_attestation_duty_to_be_served);     
        }
    }    

    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        s': DVCState,
        dv: DVState,
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_f_check_for_next_queued_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_helper_honest_helper4(
        s: DVState,
        event: DV.Event,
        s': DVState,
        s_node: DVCState,
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_helper_honest(
        s: DVState,
        event: DV.Event,
        s': DVState
    )
    requires inv_db_of_validity_predicate_contains_all_previous_decided_values_a(s)
    requires inv_active_attestation_consensus_instances_keys_is_subset_of_att_slashing_db_hist(s)
    ...
    ensures inv_g_iii_a_body_body(s', event.node, s'.honest_nodes_states[event.node], s'.index_next_attestation_duty_to_be_served); 
    {
        ...
        match event 
        {
            ...
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                ...
                lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_helper_honest_helper4(s, event, s', s_node, node);
                ...
                match nodeEvent
                {
                    case ServeAttstationDuty(attestation_duty) => 
                        ...
                        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_f_serve_attestation_duty(
                            s_node,
                            attestation_duty,
                            s'_node,
                            s', 
                    ...
                    case AttConsensusDecided(id, decided_attestation_data) =>  
                        ...
                        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_f_att_consensus_decided(
                            s_node,
                            id,
                    ...
                    case ReceivedAttestationShare(attestation_share) =>
                        ...
                        // lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_helper_easy(s', event, s_node, s'_node, node );
                        assert inv_g_iii_a_body_body(s', node, s'_node, s'.index_next_attestation_duty_to_be_served);  
                    ...
                    case ImportedNewBlock(block) => 
                        ...
                        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_f_listen_for_new_imported_blocks(
                            s_node2,
                            block,
                            s'_node,
                            s', 
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a(
        s: DVState,
        event: DV.Event,
        s': DVState
    )
    ...
    requires inv_active_attestation_consensus_instances_keys_is_subset_of_att_slashing_db_hist(s)
    requires inv_db_of_validity_predicate_contains_all_previous_decided_values_b(s) 
    ensures inv_db_of_validity_predicate_contains_all_previous_decided_values_a(s');  
    {
        assert s.att_network.allMessagesSent <= s'.att_network.allMessagesSent;
        match event 
        {
            ...
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                var s_node := s.honest_nodes_states[node];
                var s'_node := s'.honest_nodes_states[node];
                lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_helper_honest(s, event, s');
                ...
                ensures inv_g_iii_a_body_body(s', hn, s'.honest_nodes_states[hn], s'.index_next_attestation_duty_to_be_served); 
                {
                    ...
                    {
                        assert s.honest_nodes_states[hn] == s'.honest_nodes_states[hn];
                        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_helper_honest_helper4(s, event, s', s.honest_nodes_states[hn], hn);
                    }
                }  
                assert inv_db_of_validity_predicate_contains_all_previous_decided_values_a(s');
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_serve_attestation_duty(
        process: DVCState,
        attestation_duty: AttestationDuty,
        s': DVCState,
        dv: DVState,
    ...
    ensures inv_g_iii_a_a_body_body(dv, n, s')
    {
        ...
        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_check_for_next_queued_duty(new_p, s', dv, n);
    }  

    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_att_consensus_decided(
        process: DVCState,
        id: Slot,
        decided_attestation_data: AttestationData,        
        s': DVCState,
    ...
    {    
            ...
            && id == process.current_attestation_duty.safe_get().slot
        {
            ...
            lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_check_for_next_queued_duty(s_mod, s', dv, n);   
        }
    }        

    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        s': DVCState,
        dv: DVState,
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_check_for_next_queued_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey
    ...
    decreases process.attestation_duties_queue
    {
            ...
            )    
        {
            if process.attestation_duties_queue[0].slot in process.future_att_consensus_instances_already_decided.Keys
            {
                ...
                lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_check_for_next_queued_duty(
                    s_mod,
                    s',
                    dv,
                    n
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_helper_honest_helper1(
        s: DVState,
        event: DV.Event,
        s': DVState,
        s_node: DVCState,
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_helper_honest_helper2(
        s: DVState,
        event: DV.Event,
        s': DVState,
        s_node: DVCState,
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_helper_honest(
        s: DVState,
        event: DV.Event,
        s': DVState
    )
    requires inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a(s)
    ...
    ensures inv_g_iii_a_a_body_body(s', event.node, s'.honest_nodes_states[event.node]); 
    {
        ...
        match event 
        {
            ...
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                var s_node := s.honest_nodes_states[node];
                var s'_node := s'.honest_nodes_states[node];
                lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_helper_honest_helper1(s, event, s', s_node, node);
                lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_helper_honest_helper2(s, event, s', s_node, node, s.index_next_attestation_duty_to_be_served);
                ...
                match nodeEvent
                {
                    case ServeAttstationDuty(attestation_duty) => 
                        assert s.index_next_attestation_duty_to_be_served == s'.index_next_attestation_duty_to_be_served - 1;
                        lemma_ServeAttstationDuty2(s, event, s');
                        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_serve_attestation_duty(
                            s_node,
                            attestation_duty,
                            s'_node,
                            s', 
                    ...
                    case AttConsensusDecided(id, decided_attestation_data) =>  
                        lemma_NonServeAttstationDuty(s, event, s');
                        assert s.index_next_attestation_duty_to_be_served == s'.index_next_attestation_duty_to_be_served;    
                        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_att_consensus_decided(
                            s_node,
                            id,
                            decided_attestation_data,
                            s'_node,
                    ...
                    case ImportedNewBlock(block) => 
                        lemma_NonServeAttstationDuty(s, event, s');
                        var s_node2 := add_block_to_bn(s_node, nodeEvent.block);
                        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_f_listen_for_new_imported_blocks(
                            s_node2,
                            block,
                            s'_node,
                            s', 
                    ...
                    case ResendAttestationShares => 
                        lemma_NonServeAttstationDuty(s, event, s');
                        lemma_f_resend_attestation_share_constants(s_node, s'_node);
                        // lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_helper_easy(s', event, s_node, s'_node, node );
                        assert inv_g_iii_a_a_body_body(s', node, s'_node);  
    ...
    lemma lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a(
        s: DVState,
        event: DV.Event,
        s': DVState
    )
    ...
    requires inv_db_of_validity_predicate_contains_all_previous_decided_values_c(s)
    requires is_sequence_attestation_duties_to_be_served_orderd(s);
    ensures inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a(s');  
    {
        assert s.att_network.allMessagesSent <= s'.att_network.allMessagesSent;
        match event 
        {
            ...
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                var s_node := s.honest_nodes_states[node];
                var s'_node := s'.honest_nodes_states[node];
                lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_helper_honest(s, event, s');
                ...
                ensures inv_g_iii_a_a_body_body(s', hn, s'.honest_nodes_states[hn]); 
                {
                    ...
                    {
                        assert s.honest_nodes_states[hn] == s'.honest_nodes_states[hn];
                        lemma_inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a_helper_honest_helper1(s, event, s', s.honest_nodes_states[hn], hn);
                    }
                }  
                assert inv_db_of_validity_predicate_contains_all_previous_decided_values_a_a(s');
