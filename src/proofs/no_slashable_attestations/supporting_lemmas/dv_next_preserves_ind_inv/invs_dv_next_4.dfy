...
module Invs_DV_Next_4
{
    ...
    ensures inv_inv_decided_values_of_previous_duties_are_known_body_body_new(dv, n, s');
    {
        ...
        lem_concl_exists_honest_dvc_that_sent_att_share_for_submitted_att_new_f_check_for_next_duty(new_p, s', dv, n, index_next_attestation_duty_to_be_served);
    }

    lemma lem_inv_exists_decided_value_for_every_duty_before_queued_duties_body_body_f_att_consensus_decided_helper(
        process: DVCState,
        id: Slot,
    ...
    requires s_mod == f_update_process_after_att_duty_decided(
                                process,
                                id,
                                decided_attestation_data)
    ensures inv_exists_decided_value_for_every_duty_before_queued_duties_body_body(dv, n, s_mod)
    {     
    ...
    {     
        if  pred_curr_att_duty_has_been_decided(process, id)
        {
            ...
            if no_curr_duty_and_nonempty_duty_queue(s_mod)      
            {
                lem_inv_exists_decided_value_for_every_duty_before_queued_duties_body_body_f_att_consensus_decided_helper(
                    process,
                    id,
                    decided_attestation_data,        
                    dv,
            ...
            lem_concl_exists_honest_dvc_that_sent_att_share_for_submitted_att_new_f_check_for_next_duty(s_mod, s', dv, n, index_next_attestation_duty_to_be_served);  
        }           
    } 

    lemma lem_inv_exists_decided_value_for_every_duty_before_queued_duties_body_body_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        dv': DVState,
        n: BLSPubkey,
    ...
    requires && var new_consensus_instances_already_decided := f_listen_for_new_imported_blocks_helper_1(process, block);
             ...
             && no_curr_duty_and_nonempty_duty_queue(s_mod) 
    ensures inv_exists_decided_value_for_every_duty_before_queued_duties_body_body(dv', n, s_mod)
    {
    ...
    ensures inv_inv_decided_values_of_previous_duties_are_known_body_body_new(dv', n, s');
    {
        ...
        if pred_listen_for_new_imported_blocks_checker(new_process, att_consensus_instances_already_decided)
        {
            ...
            if no_curr_duty_and_nonempty_duty_queue(s_mod)   
            {
                lem_inv_exists_decided_value_for_every_duty_before_queued_duties_body_body_f_listen_for_new_imported_blocks(
                            process,
                            block,
                            dv',
                            n,
    ...
    lemma lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body_f_dequeue_attestation_duties_queue_helper2(
        process: DVCState,        
        dv: DVState,
        n: BLSPubkey,
        index_next_attestation_duty_to_be_served: nat,
    ...
    requires first_queued_att_duty_was_decided(process)
    requires s_mod == f_dequeue_attestation_duties_queue(process)
    ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(dv, n, s_mod, index_next_attestation_duty_to_be_served)
    {
        forall ad  |
        ...
        assert inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(dv, n, s_mod, index_next_attestation_duty_to_be_served);
    } 

    lemma lem_f_check_for_next_duty_checker(
        process: DVCState,        
        s_mod: DVCState
    )
    requires f_check_for_next_duty.requires(process, attestation_duty)
    ...
    lemma lem_f_check_for_next_duty_helper(
        process: DVCState,        
        dv: DVState,
        n: BLSPubkey,
        index_next_attestation_duty_to_be_served: nat,
    ...
    ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(dv, n, s_mod, index_next_attestation_duty_to_be_served)
    {
        ...
        lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body_f_dequeue_attestation_duties_queue_helper2(
                process,
                dv,
                n,
                index_next_attestation_duty_to_be_served,
    ...
    lemma lem_concl_exists_honest_dvc_that_sent_att_share_for_submitted_att_new_f_check_for_next_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    decreases process.attestation_duties_queue
    {
        if first_queued_att_duty_was_decided_or_ready_to_be_served(process)
        {
            if first_queued_att_duty_was_decided(process)
            {
                ...
                lem_f_check_for_next_duty_helper(
                    process,
                    dv,
                    n,
                    index_next_attestation_duty_to_be_served,
    ...
    predicate lem_concl_exists_honest_dvc_that_sent_att_share_for_submitted_att_new_precond(s: DVState) 
    {
        ...
        && inv_queued_att_duties_are_from_dv_seq_of_att_duties(s) //
        && inv_g_d_a(s) //
    ...
    ensures inv_exists_decided_value_for_every_duty_before_queued_duties_body_body(dv, n, s');
    {
        ...
        lem_inv_exists_decided_value_for_every_duty_before_queued_duties_f_check_for_next_duty(new_p, s', dv, n, index_next_attestation_duty_to_be_served);
    }
    ...
    ensures inv_exists_decided_value_for_every_duty_before_queued_duties_body_body(dv, n, s'); 
    {
        if  pred_curr_att_duty_has_been_decided(process, id)
        {
            ...
            lem_inv_exists_decided_value_for_every_duty_before_queued_duties_f_check_for_next_duty(s_mod, s', dv, n, index_next_attestation_duty_to_be_served);  
        }
    ...
    lemma lem_inv_exists_decided_value_for_every_duty_before_queued_duties_f_check_for_next_duty_helper_1(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    lemma lem_inv_exists_decided_value_for_every_duty_before_queued_duties_f_check_for_next_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    lemma lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_f_serve_attestation_duty(
        process: DVCState,
        attestation_duty: AttestationDuty,
        s': DVCState,
        dv: DVState,
    ...
    requires is_sequence_attestation_duties_to_be_served_orderd(dv);
    requires lem_ServeAttstationDuty2_predicate(dv, index_next_attestation_duty_to_be_served, attestation_duty, n)
    ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(dv, n, s', index_next_attestation_duty_to_be_served);
    {
        var new_p := f_enqueue_new_att_duty(
                            process,
                            attestation_duty
        ...
        lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_f_check_for_next_duty(new_p, s', dv, n, index_next_attestation_duty_to_be_served);
    }

    lemma lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_f_att_consensus_decided(
        process: DVCState,
        id: Slot,
        decided_attestation_data: AttestationData,        
        s': DVCState,
    ...
    {  
        if  pred_curr_att_duty_has_been_decided(process, id)
        {
            ...
            lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_f_check_for_next_duty(s_mod, s', dv, n, index_next_attestation_duty_to_be_served); 
        }
    } 

    lemma lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_f_listen_for_new_imported_blocks(
        process: DVCState,
        block: BeaconBlock,
        s': DVCState,
        dv': DVState,
    ...
    lemma lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_f_check_for_next_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    decreases process.attestation_duties_queue
    {
        if first_queued_att_duty_was_decided_or_ready_to_be_served(process)       
        {
            ...
            else 
            {
                ...
                assert inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(dv, n, s', index_next_attestation_duty_to_be_served);
            }
        } 
        else 
        {
    ...
    lemma lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_helper_easy(
        s: DVState,
        event: DV.Event,
        s_node: DVCState,
        s'_node: DVCState,
    ...
    requires inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(s, n, s_node, s.index_next_attestation_duty_to_be_served)
    requires s_node.attestation_duties_queue == s'_node.attestation_duties_queue
    ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(s, n, s'_node, s.index_next_attestation_duty_to_be_served)        
    {        
    }    

    lemma lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_dv_next_helper_honest(
        s: DVState,
        event: DV.Event,
        s': DVState
    )
    ...
    requires lem_concl_exists_honest_dvc_that_sent_att_share_for_submitted_att_new_precond(s)
    requires event.HonestNodeTakingStep?
    ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(s', event.node, s'.honest_nodes_states[event.node], s'.index_next_attestation_duty_to_be_served); 
    {
        assert s.att_network.allMessagesSent <= s'.att_network.allMessagesSent;
        match event 
        {
            ...
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                ...
                match nodeEvent
                {
                    case ServeAttstationDuty(attestation_duty) => 
                        assert s.index_next_attestation_duty_to_be_served == s'.index_next_attestation_duty_to_be_served - 1;
                        lem_ServeAttstationDuty(s, event, s');
                        lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_f_serve_attestation_duty(
                            s_node,
                            attestation_duty,
                            s'_node,
                            s', 
                        ...
                        assert inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(s', node, s'_node, s'.index_next_attestation_duty_to_be_served);                     
                
                    case AttConsensusDecided(id, decided_attestation_data) =>  
                        lem_NonServeAttstationDuty(s, event, s');
                        assert s.index_next_attestation_duty_to_be_served == s'.index_next_attestation_duty_to_be_served;    
                        lem_inv_db_of_validity_predicate_contains_all_previous_decided_values_helper5(s, event, s');                 
                        lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_f_att_consensus_decided(
                            s_node,
                            id,
                            decided_attestation_data,
                            s'_node,
                    ...
                    case ReceivedAttestationShare(attestation_share) =>
                        lem_NonServeAttstationDuty(s, event, s'); 
                        lem_f_listen_for_attestation_shares_constants(s_node, attestation_share, s'_node);
                        lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_helper_easy(s', event, s_node, s'_node, node );
                        assert inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(s', node, s'_node, s'.index_next_attestation_duty_to_be_served);  
                    ...
                    case ImportedNewBlock(block) => 
                        ...
                        var s_node2 := add_block_to_bn(s_node, nodeEvent.block);
                        lemma2_inv_attestation_duty_queue_is_ordered_3_body_body(s', node, s_node, s_node2);
                        lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_f_listen_for_new_imported_blocks(
                            s_node2,
                            block,
                            s'_node,
                            s', 
    ...
    lemma lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_helper_easy_2(
        s': DVState
    )
    requires forall hn |
                        && hn in s'.honest_nodes_states.Keys   
                    :: inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(s', hn, s'.honest_nodes_states[hn], s'.index_next_attestation_duty_to_be_served); 
    ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties(s')
    {

    }                 

    lemma lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_dv_next(
        s: DVState,
        event: DV.Event,
        s': DVState
    )
    ...
    ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties(s');  
    {
        ...
        match event 
        {
            ...
            case HonestNodeTakingStep(node, nodeEvent, nodeOutputs) =>
                var s_node := s.honest_nodes_states[node];
                var s'_node := s'.honest_nodes_states[node];
                lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_dv_next_helper_honest(s, event, s');
                   
                forall hn |
                    && hn in s'.honest_nodes_states.Keys   
                ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(s', hn, s'.honest_nodes_states[hn], s'.index_next_attestation_duty_to_be_served); 
                {
                    if hn != node 
                    {
                        assert s.honest_nodes_states[hn] == s'.honest_nodes_states[hn];
                        ...
                        lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_helper_easy(s', event, s.honest_nodes_states[hn], s'.honest_nodes_states[hn], hn);
                    }
                }  

                lem_inv_queued_att_duties_are_from_dv_seq_of_att_duties_helper_easy_2(s');
            ...
            case AdeversaryTakingStep(node, new_attestation_share_sent, messagesReceivedByTheNode) =>
                ...
                assert inv_queued_att_duties_are_from_dv_seq_of_att_duties(s');  
    ...
    ensures inv_g_d_a_body_body(dv, n, s');
    {
        ...
        lem_inv_g_d_a_f_check_for_next_duty(new_p, s', dv, n);
    }    
    ...
    ensures inv_g_d_a_body_body(dv, n, s'); 
    {
        if  pred_curr_att_duty_has_been_decided(process, id)
        {
            ...
            lem_inv_g_d_a_f_check_for_next_duty(s_mod, s', dv, n);     
        }   
    ...
    lemma lem_inv_g_d_a_f_check_for_next_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey
    ...
    ensures inv_attestation_duty_queue_is_ordered_3_body_body(dv, n, s');
    {
        ...
        lem_inv_attestation_duty_queue_is_ordered_3_f_check_for_next_duty(new_p, s', dv, n);
    }     
    ...
    { 
        if  pred_curr_att_duty_has_been_decided(process, id)
        {
            ...
            lemma2_inv_attestation_duty_queue_is_ordered_3_body_body(dv, n, process, s_mod);
            lem_inv_attestation_duty_queue_is_ordered_3_f_check_for_next_duty(s_mod, s', dv, n);   
        }          
    }  
    ...
    lemma lem_inv_attestation_duty_queue_is_ordered_3_f_check_for_next_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey
    ...
    ensures inv_attestation_duty_queue_is_ordered_4_body_body(dv, n, s', index_next_attestation_duty_to_be_served);
    {
        ...
        lem_inv_attestation_duty_queue_is_ordered_4_f_check_for_next_duty(new_p, s', dv, n, index_next_attestation_duty_to_be_served);
    } 
    ...
    {       
        if  pred_curr_att_duty_has_been_decided(process, id)
        {
            ...
            lem_inv_attestation_duty_queue_is_ordered_4_f_check_for_next_duty(s_mod, s', dv, n, index_next_attestation_duty_to_be_served);             
        }
    }       
    ...
    lemma lem_inv_attestation_duty_queue_is_ordered_4_f_check_for_next_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    ensures inv_g_a_iii_body_body(dv, n, s', index_next_attestation_duty_to_be_served);
    {
        ...
        lem_inv_g_a_iii_f_check_for_next_duty(new_p, s', dv, n, index_next_attestation_duty_to_be_served);
    } 
    ...
    requires 
            ...
            && s_mod ==     
                f_updateConsensusInstanceValidityCheck_in_listen_for_new_imported_blocks(
                                    new_process,
                                    att_consensus_instances_already_decided
                                )       
    ensures inv_inv_decided_values_of_previous_duties_are_known_body_body_new(dv, n, s_mod);
    ...
    {     
        if  pred_curr_att_duty_has_been_decided(process, id)
        {
            ...
            lem_inv_g_a_iii_f_check_for_next_duty(s_mod, s', dv, n, index_next_attestation_duty_to_be_served);     
        }        
    }      
    ...
    lemma lem_inv_g_a_iii_body_body_f_check_for_next_duty_helper_1(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    lemma lem_inv_g_a_iii_body_body_f_check_for_next_duty_helper_2(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    lemma lem_inv_g_a_iii_body_body_f_check_for_next_duty_helper_3(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    lemma lem_inv_g_a_iii_f_check_for_next_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
        ...
        if first_queued_att_duty_was_decided_or_ready_to_be_served(process)     
        {
            if first_queued_att_duty_was_decided(process)
            {
                    ...
                    &&  |s_mod.attestation_duties_queue| == 0 
                {
                    ...
                    lem_inv_g_a_iii_body_body_f_check_for_next_duty_helper_1(
                        process,
                        s',
                        dv,
                        n,
                ...
                if  && |s_mod.attestation_duties_queue| > 0 
                    &&   !s_mod.current_attestation_duty.isPresent()
                {
                    lem_inv_g_a_iii_body_body_f_check_for_next_duty_helper_2(
                        process,
                        s',
                        dv,
                        n,
                ...
                lem_f_check_for_next_duty_checker(
                    process,        
                    s_mod
                );      
                ...
                if 
                    ...
                    &&   s_mod.latest_attestation_duty.isPresent()     
                {
                    lem_inv_g_a_iii_body_body_f_check_for_next_duty_helper_3(
                        process,
                        s',
                        dv,
                        n,
    ...
    ensures inv_g_a_iv_a_body_body(dv, n, s') 
    {
        ...
        lem_inv_g_a_iv_f_check_for_next_duty(new_p, s', dv, n, index_next_attestation_duty_to_be_served);
    }          
    ...
    {     
        if  pred_curr_att_duty_has_been_decided(process, id)
        {
            ...
            lem_inv_g_a_iv_f_check_for_next_duty(s_mod, s', dv, n, index_next_attestation_duty_to_be_served);    
        }         
    }        
    ...
    lemma lem_inv_g_a_iv_f_check_for_next_duty_helper(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    lemma lem_inv_g_a_iv_f_check_for_next_duty_helper_2(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
        index_next_attestation_duty_to_be_served: nat,
        new_process: DVCState
    )
    requires f_check_for_next_duty.requires(process, attestation_duty)
    requires s' == f_check_for_next_duty(process, attestation_duty).state  
    requires inv_g_a_iv_a_body_body(dv, n, process)
    ...
    lemma lem_inv_g_a_iv_f_check_for_next_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey,
    ...
    decreases process.attestation_duties_queue
    {
        if first_queued_att_duty_was_decided_or_ready_to_be_served(process)        
        {
            if first_queued_att_duty_was_decided(process)
            {
                ...
                lem_inv_g_a_iv_f_check_for_next_duty_helper(
                    process,
                    s',
                    dv,
                    n,
            ...
            else 
            {
                ...
                {
                    lem_inv_g_a_iv_f_check_for_next_duty_helper_2(
                        process,
                        s',
                        dv,
                        n,
    ...
    ensures inv_g_a_iv_a_body_body(s', event.node, s'.honest_nodes_states[event.node]); 
    {
        ...
        match event 
        {
            ...
            case HonestNodeTakingStep(_, nodeEvent, nodeOutputs) =>
                ...
                assert inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(s', event.node, s_node, s.index_next_attestation_duty_to_be_served);
    ...
    ensures inv_g_d_b_body_body(dv, n, s');
    {
        ...
        lem_inv_g_d_b_f_check_for_next_duty(new_p, s', dv, n);
    }   
    ...
    ensures inv_g_d_b_body_body(dv', n, s');
    {
        ...
        if pred_listen_for_new_imported_blocks_checker(new_process, att_consensus_instances_already_decided)
        {
            ...
            lem_inv_g_d_b_f_check_for_next_duty(s_mod, s', dv', n);   
        }      
    }         
    ...
    lemma lem_inv_g_d_b_f_check_for_next_duty(
        process: DVCState,
        s': DVCState,
        dv: DVState,
        n: BLSPubkey
    ...
    // ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties_body_body(s', n, s_node, s.index_next_attestation_duty_to_be_served)
    // ensures inv_queued_att_duties_are_from_dv_seq_of_att_duties_body(s', n, s_node, s.index_next_attestation_duty_to_be_served)    
    ...
    // requires inv_only_dv_construct_signed_attestation_signature(s)
    // requires same_honest_nodes_in_dv_and_ci(s)  
    // ensures inv_queued_att_duties_are_from_dv_seq_of_att_dutiesody_body(s', s_node)  
    {
        assert s'.index_next_attestation_duty_to_be_served <= s'.index_next_attestation_duty_to_be_served <= s'.index_next_attestation_duty_to_be_served + 1;
