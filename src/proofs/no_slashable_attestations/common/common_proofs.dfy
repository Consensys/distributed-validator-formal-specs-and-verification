...
module Common_Proofs
{
    ...
    lemma lem_inv_exist_a_db_in_att_slashing_db_hist_and_an_att_duty_for_every_validity_predicate_updateAttSlashingDBHist(
    ...
    lemma lem_inv_exist_a_db_in_att_slashing_db_hist_and_an_att_duty_for_every_validity_predicate_updateConsensusInstanceValidityCheck(
        s: ConsensusEngineState,
        new_attestation_slashing_db: set<SlashingDBAttestation>,
        r: ConsensusEngineState
    )
    requires r == updateConsensusInstanceValidityCheck(s, new_attestation_slashing_db)        
    requires inv_exist_a_db_in_att_slashing_db_hist_and_an_att_duty_for_every_validity_predicate_body_ces(s)
    ...
    ensures inv_exist_a_db_in_att_slashing_db_hist_and_an_att_duty_for_every_validity_predicate_body_ces(r)
    {
        ...
        assert new_att_slashing_db_hist.Keys 
                    == s.att_slashing_db_hist.Keys + new_active_attestation_consensus_instances.Keys
                ;
        assert inv_exist_a_db_in_att_slashing_db_hist_and_an_att_duty_for_every_validity_predicate_body_ces(s);
        ...
        assert inv_exist_a_db_in_att_slashing_db_hist_and_an_att_duty_for_every_validity_predicate_body_ces(t);
        assert r.att_slashing_db_hist.Keys == t.att_slashing_db_hist.Keys;
        assert inv_exist_a_db_in_att_slashing_db_hist_and_an_att_duty_for_every_validity_predicate_body_ces(r);
    }

    lemma lem_inv_every_db_in_att_slashing_db_hist_is_a_subset_of_att_slashing_db_body_updateConsensusInstanceValidityCheck(
        s: ConsensusEngineState,
        new_attestation_slashing_db: set<SlashingDBAttestation>,
        r: ConsensusEngineState
    )
    requires r == updateConsensusInstanceValidityCheck(s, new_attestation_slashing_db)        
    requires inv_every_db_in_att_slashing_db_hist_is_a_subset_of_att_slashing_db_body_ces(s, new_attestation_slashing_db)
    requires ( forall k: Slot | k in s.active_attestation_consensus_instances.Keys ::
                    s.active_attestation_consensus_instances[k].attestation_duty.slot == k )
    ensures inv_every_db_in_att_slashing_db_hist_is_a_subset_of_att_slashing_db_body_ces(r, new_attestation_slashing_db)
    {
        lem_updateConsensusInstanceValidityCheck(s, new_attestation_slashing_db, r);
        assert r.att_slashing_db_hist.Keys
                == s.att_slashing_db_hist.Keys + s.active_attestation_consensus_instances.Keys;
        ...
        assert new_att_slashing_db_hist.Keys 
                    == s.att_slashing_db_hist.Keys + new_active_attestation_consensus_instances.Keys
                ;
        assert inv_every_db_in_att_slashing_db_hist_is_a_subset_of_att_slashing_db_body_ces(s, new_attestation_slashing_db);
        ...
        assert inv_every_db_in_att_slashing_db_hist_is_a_subset_of_att_slashing_db_body_ces(t, new_attestation_slashing_db);
        assert r.att_slashing_db_hist.Keys == t.att_slashing_db_hist.Keys;
        assert inv_every_db_in_att_slashing_db_hist_is_a_subset_of_att_slashing_db_body_ces(r, new_attestation_slashing_db);
    }    
}