...
module Consensus_Engine_NonInstr
{
    ...
    function getInitialAttConsensusEngineState(): ConsensusEngineState<AttestationConsensusValidityCheckState>
    {
        ConsensusEngineState(
            active_consensus_instances := map[]
        )
...
module Consensus_Engine_Instr
{
    ...
    function getInitialAttConsensusEngineState(): ConsensusEngineState<AttestationConsensusValidityCheckState, AttestationData, SlashingDBAttestation>
    {
        ConsensusEngineState(
            active_consensus_instances := map[],
            slashing_db_hist := map[]
    ...
    ensures && var new_active_consensus_instances := updateAttConsensusInstanceValidityCheckHelper(
                    s.active_consensus_instances,
                    new_attestation_slashing_db
                );
            && s.slashing_db_hist.Keys + new_active_consensus_instances.Keys == r.slashing_db_hist.Keys
